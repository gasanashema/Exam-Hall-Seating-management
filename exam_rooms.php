...
<body>
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Exam Rooms</h2>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <button type='button' class='btn btn-sm btn-primary mr-1' data-toggle='modal' data-target='#editRoomModal" . $row['room_id'] . "'>Edit</button>
                                    <button type='button' class='btn btn-sm btn-danger' data-toggle='modal' data-target='#deleteRoomModal" . $row['room_id'] . "'>Delete</button>
                                  </td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='2' class='text-center text-muted'>No exam rooms found</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
