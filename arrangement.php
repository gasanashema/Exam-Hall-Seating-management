    ...
    if (isset($_POST["session"])) {
        ...
        if ($conn->query($insert_sql) === TRUE) {
            ...
            foreach ($room_ids as $room_id) {
                ...
                $insert_detail_sql = "INSERT INTO seating_details (seating_arrangement_id, room_id, num_students) VALUES ('$seating_arrangement_id', '$room_id', '$num_students')";
...
<body>
    ...
    <div class="container mb-5 mt-5">
        <div class="card p-5 shadow-sm border-0">
            <h2 class="page-title mb-4">Create Exam Seating Arrangement</h2>
                ...
                <select id="teacher" class="form-control" name="teacher_id" required>
                    ...
                    if ($teachers_result->num_rows > 0) {
                        while ($teacher_row = $teachers_result->fetch_assoc()) {
                            echo "<option value='" . $teacher_row['id'] . "'>" . $teacher_row['username'] . "</option>";
                        }
                    }
                    ?>
                </select>
